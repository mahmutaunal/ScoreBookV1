...
class Scoreboard4Player : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (firstNumber.isEmpty()) {
            ...
            binding.scoreBoard4PlayerPlayer2InstantScoreText.text = "0"
            binding.scoreBoard4PlayerPlayer3InstantScoreText.text = "0"
            binding.scoreBoard4PlayerPlayer4InstantScoreText.text = "0"
        } else {
    ...
    private fun addScore() {
        ...
        val fakeButton = view.findViewById<RadioButton>(R.id.addScore4Player_fake_radioButton)
    ...
    private fun scoreboard() {
        ...
        val player1ScoreText =
            view.findViewById<TextView>(R.id.scoreboard4Player_player1Score_textView)
        val player2ScoreText =
            view.findViewById<TextView>(R.id.scoreboard4Player_player2Score_textView)
        val player3ScoreText =
            view.findViewById<TextView>(R.id.scoreboard4Player_player3Score_textView)
        val player4ScoreText =
            view.findViewById<TextView>(R.id.scoreboard4Player_player4Score_textView)
    ...
    private fun winnerTeam() {
        ...
        if (winType == "Lowest Score") {
            ...
            when {
                ...
                ((player4Score < player1Score) && (player4Score < player2Score) && (player4Score < player3Score)) -> {
                    winnerTeam.text = "$player4Name ${getString(R.string.won_text)}."
                }
    ...
    private fun scoreDetailPage(position: Int) {
        ...
        //set visibility
        if ((redValue == 1 && blueValue == 1 && yellowValue == 1 && blackValue == 1 && fakeValue == 1) || scoreList4Player[position].colorValue) {
    ...
    private fun editScore(position: Int, selectedGameNumber: Int) {
        ...
        val player3ScoreWithoutMultiply = selectedScore3.toInt() / multiplyNumber
        val player4ScoreWithoutMultiply = selectedScore4.toInt() / multiplyNumber

        player1Score.setText(player1ScoreWithoutMultiply.toString())
        player2Score.setText(player2ScoreWithoutMultiply.toString())
        player3Score.setText(player3ScoreWithoutMultiply.toString())
        player4Score.setText(player4ScoreWithoutMultiply.toString())
        ...
        addDialog.setPositiveButton(R.string.edit_text) { dialog, _ ->
            ...
            if (player1Score!!.text.isEmpty()) {
                ...
                if (gameType == "Add Score") {
                    ...
                    scoreList4Player[position].colorValue = colorValue
